...
class net:
    ...
    def Model(self, num_classes=3, in_channels=3):
    ...
    def inferencia_modelo(self, pathR, pathG, pathB):
        # Ler os dados binários dos arquivos
        ...
        # Decodificar as imagens em escala de cinza
        ...
        rgb_image = cv2.merge([image_R, image_G, image_B])
